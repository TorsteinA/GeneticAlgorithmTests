...
namespace Santom
{
    ...
    {
        private static double DegToRadFactor = Math.PI / 180;
        /// <summary>
        ...
        /// <summary>
        /// Converts a degrees to radians. NOTE: does not change the value of the double
        /// </summary>
        ...
        {
            return value.ToThePowerOf(2);
        }

        public static double ToThePowerOf(this double baseValue, double exponent)
        {
